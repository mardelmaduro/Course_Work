...
public class WishListItemTest extends TestCase
{
    ...
    public void testWishListWithItemNameOnly()
    {
        ...
        assertEquals(720.1840000000001, wish1.getAmount());
    ...
    public void testWishListWithItemNameAndPriceOnly()
    {
        ...
        assertEquals(772.4925000000001, wish1.getAmount());
    ...
    public void testWishListWithItemNamePriceAndDiscount()
    {
        ...
        assertNotNull(wish1);
        assertEquals("iPhone 11", wish1.getName());
        assertEquals(1699.9914999999999, wish1.getAmount());
        assertEquals(0, wish1.getPriority());
        ...
        wish1.setDiscount(25);
        assertEquals(1019.9936249999998, wish1.getAmount());
